...
class RetireFrame extends JFrame {
    ...
    public RetireFrame()
    {
        ...
        add(savingsField, new GBC(1, 1).setWeight(100,
                0).setFill(GBC.HORIZONTAL));
        add(contribField, new GBC(3, 1).setWeight(100,
                0).setFill(GBC.HORIZONTAL));
        add(incomeField, new GBC(5, 1).setWeight(100,
                0).setFill(GBC.HORIZONTAL));
        add(currentAgeField, new GBC(1, 2).setWeight(100,
                0).setFill(GBC.HORIZONTAL));
        add(retireAgeField, new GBC(3, 2).setWeight(100,
                0).setFill(GBC.HORIZONTAL));
        add(deathAgeField, new GBC(5, 2).setWeight(100,
                0).setFill(GBC.HORIZONTAL));
        add(inflationPercentField, new GBC(1, 3).setWeight(100,
                0).setFill(GBC.HORIZONTAL));
        add(investPercentField, new GBC(3, 3).setWeight(100,
                0).setFill(GBC.HORIZONTAL));
        add(retireCanvas, new GBC(0, 4, 4, 1).setWeight(100,
    ...
    private void setCurrentLocale(Locale locale) {
        ...
        res = ResourceBundle.getBundle("chapter2_7.RetireResources", currentLocale);
        resStrings = ResourceBundle.getBundle("chapter2_7.RetireStrings", currentLocale);
...
class RetireComponent extends JComponent
{
    ...
    /**
     * Sets the retirement information to b plotted.
