...
public class LoggingImageViewer {
    public static void main(String[] args) {
        ...
        System.getProperty("java.util.logging.config.file") == null) {
            try {
                Logger.getLogger("chapter1_7.Logging").setLevel(Level.ALL);
                final int LOG_ROTATION_COUNT = 10;
                Handler handler = new FileHandler("./LoggingImageViewer.log", 0, LOG_ROTATION_COUNT);
                Logger.getLogger("chapter1_7.Logging").addHandler(handler);
            } catch (IOException ex) {
                Logger.getLogger("chapter1_7.Logging").log(Level.SEVERE, "Can't create log file handler.", ex);
            } // catch
        } // if
        ...
        EventQueue.invokeLater(() -> {
            ...
            Logger.getLogger("chapter1_7.Logging").addHandler(winHandler);

            JFrame frame = new ImageViewerFrame();
            frame.setTitle("LoggingImageViewer");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

            Logger.getLogger("chapter1_7.Logging").fine("Showing frame.");
...
class ImageViewerFrame extends JFrame{
    ...
    private static Logger logger = Logger.getLogger("chapter1_7.Logging");
